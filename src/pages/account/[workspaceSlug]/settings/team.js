...
// Note: InvitationStatus and TeamRole are now strings in our SQLite schema
...
const MEMBERS_TEMPLATE = { email: '', role: 'MEMBER' };
...
const Team = ({ isTeamOwner, workspace }) => {
  ...
  return (
    <AccountLayout>
      <Meta title={`Vitmail-C - ${workspace.name} | Team Management`} />
      <Content.Title
